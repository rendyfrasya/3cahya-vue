	...
	<div class="drawer-side">
		...
		<div class="menu bg-base-200 text-base-content min-h-full w-[13rem] p-4">
			...
			<div class="fixed bottom-5 p-4 w-full">
				...
				<p class="font-normal text-sm lg:text-base ml-2">Logout</p>
				</Link>
			</div>
		</div>
	</div>
